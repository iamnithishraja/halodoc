...
class ToctorAIService {
    ...
    private getSystemPrompt(): string {
        return `You are Toctor AI, an advanced medical AI assistant integrated into the HaloDoc healthcare platform. You provide personalized medical guidance, symptom analysis, and healthcare recommendations based on comprehensive patient data.

        ...
        <View style={{ paddingHorizontal: 24, paddingVertical: 40, backgroundColor: '#F8FAFC' }}>
          <View style={{ alignItems: 'center', marginBottom: 32 }}>
            ...
            <Text style={{ 
              ...
              halodoc is a comprehensive healthcare platform that connects patients with doctors, laboratories, and pharmacies. We leverage technology to make healthcare accessible, convenient, and efficient for everyone.
            </Text>
          </View>
        ...
        <View style={{ paddingHorizontal: 24, marginBottom: 40, paddingVertical: 40, backgroundColor: '#F8FAFC' }}>
          ...
          >
            ...
            <Text style={{ 
              ...
              Join thousands of users who trust halodoc for their healthcare needs
            </Text>
        ...
        <View style={{ paddingHorizontal: 24, paddingVertical: 32, backgroundColor: '#111827' }}>
          <View style={{ alignItems: 'center' }}>
            ...
            <Text style={{ color: '#9CA3AF', textAlign: 'center', marginTop: 16, fontSize: 12 }}>
              © 2024 HaloDoc. All rights reserved.
            </Text>
